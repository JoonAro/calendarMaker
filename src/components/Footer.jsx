      ...
      <div className='container mx-auto py-12  '>
        <div className='grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-4 md:gap-16'>
          <div className='py-8 '> {/* Add padding here */}
            ...
            <p className='text-base mb-4 w-40'>Dream calendar works to make your dreams come true by planning your day. You shape your life, you style your calendar the way you want. We are here to help you reach your goals.</p>
          </div>
          <div className=' py-8  '> {/* Add padding here */}
