      ...
      <div className='container mx-auto py-12 '>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16'>
          <div className='py-8 '> {/* Add padding here */}
            ...
            <p className='text-base mb-4 ml-'>Dream calendar works to make your dreams come true by planning your day. You shape your life, you style your calendar the way you want. We are here to help you reach your goals.</p>
          </div>
          <div className=' py-8  '> {/* Add padding here */}
